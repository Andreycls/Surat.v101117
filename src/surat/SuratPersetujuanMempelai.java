 ...
 * @author asemJr
 */
public class SuratPersetujuanMempelai {
class MyFooter extends PdfPageEventHelper {
        ...
        Font fCalon = new Font(Font.FontFamily.HELVETICA, 12, Font.BOLD);
        ...
        public void onEndPage(PdfWriter writer, Document document) {
            ...
            Paragraph Judul = new Paragraph(" SURAT PERSETUJUAN MEMPELAI",fJudul);
            ...
            Paragraph Model = new Paragraph("Model : N3",fModel);
            ...
            Paragraph Nama = new Paragraph      ("Nama                                 :",fPara);
            ...
            Paragraph tCalonSuami = new Paragraph      ("I. Calon Suami   ",fCalon);
            Paragraph tCalonIstri = new Paragraph      ("II. Calon Istri   ",fCalon);
            Paragraph NamaPria = new Paragraph      ("1.Nama                                 :",fPara);
            Paragraph TTLPria = new Paragraph       ("3.Tempat dan Tanggal lahir  :",fPara);
            Paragraph UsiaPria = new Paragraph      ("Usia                                 :",fPara);
            Paragraph WargaPria = new Paragraph     ("4.Kewarganegaraan              :",fPara);
            Paragraph BIN = new Paragraph   ("2.BIN                             :",fPara);
            Paragraph AgamaPria = new Paragraph     ("5.Agama                                :",fPara);
            Paragraph PekerjaanPria = new Paragraph ("6.Pekerjaan                           :",fPara);
            Paragraph TempatTinggalPria = new Paragraph("7.Tempat Tinggal                    :  ",fPara);

            Paragraph NamaWanita = new Paragraph      ("1.Nama                                 :",fPara);
            Paragraph TTLWanita = new Paragraph       ("3.Tempat dan Tanggal lahir  :",fPara);
            Paragraph UsiaWanita = new Paragraph      ("Usia                                 :",fPara);
            Paragraph WargaWanita = new Paragraph     ("4.Kewarganegaraan              :",fPara);
            Paragraph KelaminWanita = new Paragraph   ("Jenis Kelamin                     :",fPara);
            Paragraph AgamaWanita = new Paragraph     ("5.Agama                                :",fPara);
            Paragraph PekerjaanWanita = new Paragraph ("6.Pekerjaan                           :",fPara);
            Paragraph TempatTinggalWanita = new Paragraph("7.Tempat Tinggal                    :  ",fPara);
            Paragraph BINWanita = new Paragraph("2.BIN                    :  ",fPara);


//            Paragraph binti = new Paragraph     ("Binti                                    :");
            Paragraph KalimatKeempat = new Paragraph("Menyatakan dengan sesungguhnya bahwa atas dasar suka rela, "
        + " dengan kesadaran sendiri, tanpa paksaan dari siapapun juga,",fPara);
            Paragraph KalimatKeempat1 = new Paragraph("setuju untuk melangsungkan pernikahan.",fPara);
            Paragraph KalimatPenutup = new Paragraph("Demikian surat keterangan ini untuk dipergunakan sebagaimana mestinya.",fPara);
            ...
            Paragraph namaKepalaDesa = new Paragraph("Andrey Sembiring,STh",fPara);
...
//                    document.top() - 65, 0);
    ...
    public static final String DEST = "D:/Kerjaan/Project/Sistem Informasi InfoDes App (Desktop Application)/Hasil/SuratPersetujuanMempelai.pdf";
 
    public static void main(String[] args) throws IOException, DocumentException {
        File file = new File(DEST);
        file.getParentFile().mkdirs();
        new SuratPersetujuanMempelai().createPdf(DEST);
    }
