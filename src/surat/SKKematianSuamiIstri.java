 ...
 * @author asemJr
 */
public class SKKematianSuamiIstri {
class MyFooter extends PdfPageEventHelper {
        ...
        public void onEndPage(PdfWriter writer, Document document) {
            ...
            Paragraph Judul = new Paragraph(" SURAT KEMATIAN SUAMI ISTRI",fJudul);
            ...
            Paragraph Model = new Paragraph("Model : N6",fModel);
            ...
            Paragraph KalimatIjin = new Paragraph("memberikan ijin kepadanya untuk melakukan pernikahan dengan ;",fPara);
            Paragraph KalimatSK = new Paragraph ("adalah benar Suami/istri yang telah meninggal tersebut di atas.",fPara);
            ...
            Paragraph NamaLain = new Paragraph      ("Nama                                 :",fPara);
            Paragraph TTLLain = new Paragraph       ("Tempat dan Tanggal lahir  :",fPara);
            Paragraph UsiaLain = new Paragraph      ("Usia                                 :",fPara);
            Paragraph WargaLain = new Paragraph     ("Kewarganegaraan              :",fPara);
            Paragraph KelaminLain = new Paragraph   ("Jenis Kelamin                     :",fPara);
            Paragraph AgamaLain = new Paragraph     ("Agama                                :",fPara);
            Paragraph PekerjaanLain = new Paragraph ("Pekerjaan                           :",fPara);
            Paragraph TempatTinggalLain = new Paragraph("Tempat Tinggal                    :  ",fPara);
...
//            Paragraph binti = new Paragraph     ("Binti                                    :");
            ...
            Paragraph tIbu = new Paragraph("II.Ibu",fPara);
            Paragraph tAyah = new Paragraph("I.Ayah",fPara);
...
//                    document.top() - 65, 0);
    ...
    public static final String DEST = "D:/Kerjaan/Project/Sistem Informasi InfoDes App (Desktop Application)/Hasil/SKKematianSuamiIstri.pdf";
 
    public static void main(String[] args) throws IOException, DocumentException {
        File file = new File(DEST);
        file.getParentFile().mkdirs();
        new SKKematianSuamiIstri().createPdf(DEST);
    }
