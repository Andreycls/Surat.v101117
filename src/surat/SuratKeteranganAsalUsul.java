 ...
 * @author asemJr
 */
public class SuratKeteranganAsalUsul {
class MyFooter extends PdfPageEventHelper {
        ...
        public void onEndPage(PdfWriter writer, Document document) {
            ...
            Paragraph Judul = new Paragraph(" SURAT KETERANGAN ASAL USUL",fJudul);
            ...
            Paragraph Model = new Paragraph("Model : N-2",fModel);
            ...
            Paragraph NamaPria = new Paragraph      ("Nama                                 :",fPara);
...
//                    document.top() - 65, 0);
    ...
    public static final String DEST = "D:/Kerjaan/Project/Sistem Informasi InfoDes App (Desktop Application)/Hasil/SuratKeteranganAsalUsul.pdf";
 
    public static void main(String[] args) throws IOException, DocumentException {
        File file = new File(DEST);
        file.getParentFile().mkdirs();
        new SuratKeteranganAsalUsul().createPdf(DEST);
    }
