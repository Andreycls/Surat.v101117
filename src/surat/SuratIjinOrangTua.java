 ...
 * @author asemJr
 */
public class SuratIjinOrangTua {
class MyFooter extends PdfPageEventHelper {
        ...
        public void onEndPage(PdfWriter writer, Document document) {
            ...
            Paragraph Judul = new Paragraph(" SURAT IJIN ORANG TUA",fJudul);
            ...
            Paragraph Model = new Paragraph("Model : N5",fModel);
...
//                    document.top() - 65, 0);
    ...
    public static final String DEST = "D:/Kerjaan/Project/Sistem Informasi InfoDes App (Desktop Application)/Hasil/SuratIjinOrangTua.pdf";
 
    public static void main(String[] args) throws IOException, DocumentException {
        File file = new File(DEST);
        file.getParentFile().mkdirs();
        new SuratIjinOrangTua().createPdf(DEST);
    }
